...
#define DMP_DATA_RDY_STATUS (8 * 16 + 10) // 16-bit: indicates to DMP which sensors are available
...
#define ICM20948_DMP_Header_Bytes 2
#define ICM20948_DMP_Header2_Bytes 2
#define ICM20948_DMP_Raw_Accel_Bytes 6
#define ICM20948_DMP_Raw_Gyro_Bytes 6
#define ICM20948_DMP_Gyro_Bias_Bytes 6
#define ICM20948_DMP_Compass_Bytes 6
#define ICM20948_DMP_ALS_Bytes 8
#define ICM20948_DMP_Quat6_Bytes 12
#define ICM20948_DMP_Quat9_Bytes 14
// <-- lcm20948MPUFifoControl.c suggests ICM20948_DMP_Step_Detector_Bytes comes here <--
#define ICM20948_DMP_PQuat6_Bytes 6
#define ICM20948_DMP_Geomag_Bytes 14
#define ICM20948_DMP_Pressure_Bytes 6
#define ICM20948_DMP_Gyro_Calibr_Bytes 12 // lcm20948MPUFifoControl.c suggests ICM20948_DMP_Gyro_Calibr_Bytes is not supported?
#define ICM20948_DMP_Compass_Calibr_Bytes 12
#define ICM20948_DMP_Step_Detector_Bytes 4 // See note above
#define ICM20948_DMP_Accel_Accuracy_Bytes 2
#define ICM20948_DMP_Gyro_Accuracy_Bytes 2
#define ICM20948_DMP_Compass_Accuracy_Bytes 2
#define ICM20948_DMP_Fsync_Detection_Bytes 2 // lcm20948MPUFifoControl.c suggests ICM20948_DMP_Fsync_Detection_Bytes is not supported?
#define ICM20948_DMP_Pickup_Bytes 2
#define ICM20948_DMP_Activity_Recognition_Bytes 6
#define ICM20948_DMP_Secondary_On_Off_Bytes 2
#define ICM20948_DMP_Footer_Bytes 2
#define ICM20948_DMP_Maximum_Bytes 14 // The most bytes we will attempt to read from the FIFO in one go
...
typedef struct
{
    ...
    union
    {
        uint8_t Bytes[ICM20948_DMP_Raw_Accel_Bytes];
        struct
        {
            int16_t X;
            int16_t Y;
    ...
    union
    {
        uint8_t Bytes[ICM20948_DMP_Raw_Gyro_Bytes + ICM20948_DMP_Gyro_Bias_Bytes];
        struct
        {
            int16_t X;
            int16_t Y;
    ...
    union
    {
        uint8_t Bytes[ICM20948_DMP_Compass_Bytes];
        struct
        {
            int16_t X;
            int16_t Y;
    ...
    uint8_t ALS[ICM20948_DMP_ALS_Bytes]; // Byte[0]: Dummy, Byte[2:1]: Ch0DATA, Byte[4:3]: Ch1DATA, Byte[6:5]: PDATA, Byte[7]: Dummy
    ...
    union
    {
        uint8_t Bytes[ICM20948_DMP_Quat6_Bytes];
        struct
        {
            int32_t Q1;
            int32_t Q2;
    ...
    union
    {
        uint8_t Bytes[ICM20948_DMP_Quat9_Bytes];
        struct
        {
            int32_t Q1;
            int32_t Q2;
    ...
    union
    {
        uint8_t Bytes[ICM20948_DMP_PQuat6_Bytes];
        struct
        {
            int16_t Q1;
            int16_t Q2;
    ...
    union
    {
        uint8_t Bytes[ICM20948_DMP_Geomag_Bytes];
        struct
        {
            int32_t Q1;
            int32_t Q2;
    ...
    union
    {
        uint8_t Bytes[ICM20948_DMP_Gyro_Calibr_Bytes];
        struct
        {
            int32_t X;
            int32_t Y;
    ...
    union
    {
        uint8_t Bytes[ICM20948_DMP_Compass_Calibr_Bytes];
        struct
        {
            int32_t X;
            int32_t Y;
    ...
    union
    {
        uint8_t Bytes[ICM20948_DMP_Activity_Recognition_Bytes];
        struct
        {
    ...
    union
    {
        uint8_t Bytes[ICM20948_DMP_Secondary_On_Off_Bytes];
        icm_20948_DMP_Secondary_On_Off_t Sensors;
    } Secondary_On_Off;
    uint16_t Footer; // Gyro count?
} ICM20948_DMP_data_t;

// extern const uint16_t inv_androidSensor_to_control_bits[ANDROID_SENSOR_NUM_MAX] =
//     {
